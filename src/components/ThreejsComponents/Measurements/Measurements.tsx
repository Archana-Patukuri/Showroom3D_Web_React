...
function LoadModel() {
  ...
  let { controls, renderer, camera } = useContext(BasicContext);
  ...
  const onClickMovement = (isChecked: any) => {
    if (isChecked) {
      console.log("Entered to onClick");
      renderer.domElement.addEventListener("click", measurements);
    } else {
      console.log("Entered to un onClick");
  ...
  useEffect(() => {
    if (checked) {
      ...
      console.log("Camera enable:", camera, ":-", checked);
      onClickMovement(checked);
    } else {
      controls.enabled = true;
      console.log("Camera disable:", camera, ":-", checked);
