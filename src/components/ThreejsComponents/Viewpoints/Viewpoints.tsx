      ...
      <div style={{ fontSize: "12px" }}>
        <div className="d-flex flex-row">
          <input
            ...
            value="0"
            onChange={(e) => {
              ViewPointsHandler(e, ViewpointValues[0]);
            }}
          />
        ...
        <div className="d-flex flex-row" style={{ marginTop: "2px" }}>
          <input
            ...
            value="1"
            onChange={(e) => {
              ViewPointsHandler(e, ViewpointValues[1]);
            }}
          />
          <label>Table</label>
        </div>
        <div className="d-flex flex-row" style={{ marginTop: "2px" }}>
          <input
            ...
            value="2"
            onChange={(e) => {
              ViewPointsHandler(e, ViewpointValues[2]);
            }}
          />
          <label>Chair</label>
        </div>
        <div className="d-flex flex-row" style={{ marginTop: "2px" }}>
          <input
            ...
            value="3"
            onChange={(e) => {
              ViewPointsHandler(e, ViewpointValues[3]);
            }}
          />
          <label>Blinds</label>
        </div>
        <div className="d-flex flex-row" style={{ marginTop: "2px" }}>
          <input
            ...
            value="4"
            onChange={(e) => {
              ViewPointsHandler(e, ViewpointValues[4]);
            }}
          />
          <label>Ceiling</label>
        </div>
        <div className="d-flex flex-row" style={{ marginTop: "2px" }}>
          <input
            ...
            value="5"
            onChange={(e) => {
              ViewPointsHandler(e, ViewpointValues[5]);
            }}
          />
          <label>Back</label>
        </div>
        <div className="d-flex flex-row" style={{ marginTop: "2px" }}>
          <input
            ...
            value="6"
            onChange={(e) => {
              ViewPointsHandler(e, ViewpointValues[6]);
            }}
          />
          <label>Monitor</label>
        </div>
